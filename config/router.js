...
router.get('/movedhome').to('Main.index');
router.get('/movedhome/withphpextension/index.php').to('Main.index');
router.get('/movedhome/withphpextension/index2.php').to('Main.index');
